package edu.rvc.student.whackanandroid
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var btnImgButton = findViewById<ImageButton>(R.id.btnImgMole)
    ...
    fun ChangeImage(){
        ...
        btnImgMole.setTranslationX(x)
        btnImgMole.setTranslationY(y)
